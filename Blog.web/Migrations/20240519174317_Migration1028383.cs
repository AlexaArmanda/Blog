...
{
    /// <inheritdoc />
    public partial class Migration1028383 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogPostTag", x => new { x.BlogPostsBlogPostId, x.TagsTagId });
                    table.ForeignKey(
                        name: "FK_BlogPostTag_BlogPosts_BlogPostsBlogPostId",
